...
h2o_path = "A:\thomasu\raw_data\2024-02-20\5-12um_beads_h2o_pbs\20240220.144248_mass_results\2024-02-20_5-12um_beads_h2o_pbs.csv";
d2o_path = "A:\thomasu\raw_data\2024-02-20\5-12um_beads_d2o_pbs\20240220.144201_mass_results\2024-02-20_5-12um_beads_d2o_pbs.csv";
slope = -148486.57307736989;
intercept = 1.3079261211476924E+6;
...
% h2o_rf = 1158724;
% d2o_rf = 1142951;
% intercept = 1.3075456366477804E+6;
% slope = -148222.55739718326;
% 
% bl_dens1 = (h2o_rf - intercept) / slope;
% bl_dens2 = (d2o_rf - intercept) / slope;
% 
% bm1 = p1_vol .* (p_dens - bl_dens1');
% bm2 = p2_vol .* (p_dens - bl_dens2');


% figure(fh_hist_h2o); 
% xline(bm1(1), LineWidth=1.5, Color='m', DisplayName='Estimated BM from calibration');
% xline(bm1(2:end), LineWidth=1.5, Color='m', HandleVisibility='off');
% [N, edges] = histcounts(mt_tab.fl1_mass_pg, 'BinWidth', 0.4);
% histogram('BinEdges', edges, 'BinCounts', N / sum(N), 'FaceColor', 'blue', 'FaceAlpha', 0.2, 'EdgeAlpha', 0.2, 'DisplayName', 'Density trap BMs')

% figure(fh_hist_d2o); 
% xline(bm2(1), LineWidth=1.5, Color='m', DisplayName='Estimated BM from calibration');
% xline(bm2(2:end), LineWidth=1.5, Color='m', HandleVisibility='off');
% [N, edges] = histcounts(mt_tab.fl2_mass_pg, 'BinWidth', 0.4);
% histogram('BinEdges', edges, 'BinCounts', N / sum(N), 'FaceColor', 'blue', 'FaceAlpha', 0.2, 'EdgeAlpha', 0.2, 'DisplayName', 'Density trap BMs')