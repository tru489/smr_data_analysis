...
labels = ["Rep" + string(1:num_replicates) + "_ntarget" "Rep" + string(1:2) + "_ntreat" "Rep" + string(1:num_replicates) + "_siRNA1" "Rep" + string(1:num_replicates) + "_siRNA2"];
dry_tab = table();
...
dry_tab.total_volume_fl = [2567.92	2481.25	2261.61	2287.92	2403.33]';
