...
h2o_low_paths = ls("908_data\h2o_low");
h2o_high_paths = ls("908_data\h2o_high");
d2o_low_paths = ls("908_data\d2o_low");
d2o_high_paths = ls("908_data\d2o_high");
...
h2o_low_thresh = [15 inf];
h2o_high_thresh = [15 110];

d2o_low_thresh = [15 inf];
d2o_high_thresh = [15 50];
...
h2o_low_bm = get_mean_bms_and_save(h2o_low_paths, h2o_low_thresh, '908_results');
h2o_high_bm = get_mean_bms_and_save(h2o_high_paths, h2o_high_thresh, '908_results');
d2o_low_bm = get_mean_bms_and_save(d2o_low_paths, d2o_low_thresh, '908_results');
d2o_high_bm = get_mean_bms_and_save(d2o_high_paths, d2o_high_thresh, '908_results');
...
writetable(dry_tab, '908_results\dry_properties.csv')
