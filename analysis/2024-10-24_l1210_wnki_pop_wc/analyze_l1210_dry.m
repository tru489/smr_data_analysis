...
h2o_wnkin11_thresh = [20 200];
d2o_wnkin11_thresh = [15 120];
h2o_wnk463_thresh = [20 200];
d2o_wnk463_thresh = [15 120];
...
dry_tab.total_volume_fl = [717.352	700.063	712.95	649.22	654.559	656.788	882.409	888.13	893.109]';
