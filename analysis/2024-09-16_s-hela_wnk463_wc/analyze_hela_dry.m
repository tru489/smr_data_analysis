...
h2o_wnk_thresh = [40 600];
d2o_wnk_thresh = [30 600];
h2o_dmso_thresh = [40 600];
d2o_dmso_thresh = [30 600];

%% Density baseline calculation
h2o_trm_dens_arr = get_avg_density(h2o_wnk_paths, h2o_wnk_thresh, slope, intc, h2o_rf);
...
d2o_trm_dens_arr = get_avg_density(d2o_wnk_paths, d2o_wnk_thresh, slope, intc, d2o_rf);
...
[dens_wnk, vol_wnk] = calc_dry_dens_vol(h2o_wnk_bm, d2o_wnk_bm, h2o_trm_dens_arr, d2o_trm_dens_arr);
...
dry_tab.total_volume_fl = [2108 2037 2066 2943 2872 2935]';
