...
h2o_low_paths = ls("362_data\h2o_low");
h2o_high_paths = ls("362_data\h2o_high");
d2o_low_paths = ls("362_data\d2o_low");
d2o_high_paths = ls("362_data\d2o_high");
...
h2o_low_thresh = [6 150];
h2o_high_thresh = [6 150];

d2o_low_thresh = [5 inf];
d2o_high_thresh = [5 inf];
...
h2o_low_bm = get_mean_bms_and_save(h2o_low_paths, h2o_low_thresh, '362_results');
h2o_high_bm = get_mean_bms_and_save(h2o_high_paths, h2o_high_thresh, '362_results');
d2o_low_bm = get_mean_bms_and_save(d2o_low_paths, d2o_low_thresh, '362_results');
d2o_high_bm = get_mean_bms_and_save(d2o_high_paths, d2o_high_thresh, '362_results');
...
writetable(dry_tab, '362_results\dry_properties.csv')
