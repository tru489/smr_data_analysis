...
h2o_low_paths = ls("908_data_new\h2o_low");
h2o_high_paths = ls("908_data_new\h2o_high");
d2o_low_paths = ls("908_data_new\d2o_low");
d2o_high_paths = ls("908_data_new\d2o_high");
...
h2o_low_thresh = [45 inf];
h2o_high_thresh = [28 inf];

d2o_low_thresh = [30 inf];
d2o_high_thresh = [20 150];
...
h2o_low_bm = get_mean_bms_and_save(h2o_low_paths, h2o_low_thresh, '908_results_new');
h2o_high_bm = get_mean_bms_and_save(h2o_high_paths, h2o_high_thresh, '908_results_new');
d2o_low_bm = get_mean_bms_and_save(d2o_low_paths, d2o_low_thresh, '908_results_new');
d2o_high_bm = get_mean_bms_and_save(d2o_high_paths, d2o_high_thresh, '908_results_new');
...
labels = ["Rep" + string(1:num_replicates) + "_low" "Rep" + string(1:num_replicates) + "_high"];
dry_tab = table();
...
writetable(dry_tab, '908_results_new\dry_properties.csv')
