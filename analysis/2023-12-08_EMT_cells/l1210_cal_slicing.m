...
paired_data_path = "A:\thomasu\raw_data\2023-12-08\l1210_control\20231214.110243_fl_excl_results\readout_paired.txt";
...
mass_slice = (mass_pg > 25) & (mass_pg < 100);
vol_slice = (vol_au > 39) & (vol_au < 140);
slice_combine = mass_slice & vol_slice;
...
saveas(f1, save_path + "l120_mass_hist.jpg")

f2 = figure;
vol_cal_factor_fl_per_au = 16.7364321738498;
