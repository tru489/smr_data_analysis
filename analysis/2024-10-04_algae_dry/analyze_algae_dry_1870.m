...
h2o_low_paths = ls("data\1870_low_h2o");
h2o_high_paths = ls("data\1870_high_h2o");
h2o_n_paths = ls("data\1870_-n_h2o");
h2o_p_paths = ls("data\1870_-p_h2o");

d2o_low_paths = ls("data\1870_low_d2o");
d2o_high_paths = ls("data\1870_high_d2o");
d2o_n_paths = ls("data\1870_-n_d2o");
...
% plot_pths_for_thresholding(h2o_p_paths, 'h2o\_p')
...
% plot_pths_for_thresholding(d2o_p_paths, 'd2o\_p')
...
h2o_dens = mean([low_h2o_dens_arr, high_h2o_dens_arr, n_h2o_dens_arr, p_h2o_dens_arr]);
...
d2o_dens = mean([low_d2o_dens_arr, high_d2o_dens_arr, n_d2o_dens_arr, p_d2o_dens_arr]);
...
labels = ["Rep" + string(1:num_reps) + "_low" "Rep" + string(1:num_reps) + "_high" "Rep" + string(1:num_reps) + "_-n" "Rep" + string(1:num_reps) + "_-p "];
dry_tab = table();
dry_tab.labels = labels';
dry_tab.dry_density_gcm3 = [dens_low, dens_high, dens_n, dens_p]';
dry_tab.dry_volume_fl = [vol_low, vol_high, vol_n, vol_p]';
dry_tab.avg_buoyant_mass_h2o = [h2o_low_bm, h2o_high_bm, h2o_n_bm, h2o_p_bm]';
dry_tab.avg_buoyant_mass_d2o = [d2o_low_bm, d2o_high_bm, d2o_n_bm, d2o_p_bm]';
dry_tab.avg_density_h2o_gcm3 = repmat(h2o_dens, 1, num_reps*4)';
dry_tab.avg_density_d2o_gcm3 = repmat(d2o_dens, 1, num_reps*4)';
