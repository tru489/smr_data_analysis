function [Peak, tempstart, tempend] = P2_find_pmt_peaks(peak, ...
    uni_peak_window_ext)
% Routine for finding individual PMT peaks
% 
% Arguments:
%   peak (struct): relevant data for a peak
%   uni_peak_window_ext (int): Number of data points from each side of 
%       detection cutoff to be considered as part of the peak]
% Returns:
%   Peak (struct): compiled peak data
