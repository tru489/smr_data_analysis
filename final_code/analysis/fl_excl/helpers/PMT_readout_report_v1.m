function  PMT_readout_report_v1(report_dir,sample_name, analysis_params, readout_pmt, QC_msg)
...
rpt = Report(fullfile(report_dir, append("PMT_readout_report_", time_stamp)), 'pdf');
open(rpt)
