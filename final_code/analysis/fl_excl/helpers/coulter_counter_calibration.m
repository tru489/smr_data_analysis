function [refine_calibration_factor, cc_hist_bin_edges, cc_hist_bin_counts] = ...
    coulter_counter_calibration(run_params, Coulter_data, sample)
...
while refinement_pass ~= 1
    ...
    subplot(1,2,1)
        cc_hist_bin_edges = [0;Vol_data.volume_fL]';
        cc_hist_bin_counts = Vol_data.count;
