...
run_params.density_trap.candidate_pair_dens_window = [1.03, 1.07]; % g/cm3
...
run_params.curation.nod_dev_thresh = 0.4; % 0.4 % 0.1
%% 
...
run_params.fl_excl.detect_thresh_pmt(1) = -1.2; % -2.5 nl 
...
run_params.fl_excl.thresh_base_height_range = 0.5; % nl 0.05

% Use calibration with coulter counter data, or use manually input parameter?
run_params.fl_excl.use_coulter_calibration = 1;
run_params.fl_excl.manual_fl_per_au_cal_factor = 0;
