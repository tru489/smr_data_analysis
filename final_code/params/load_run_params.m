...
%% Fall back to a generic default raw data dir if the configured one doesn't exist here
if ~isfolder(run_params.dir_formatting.default_raw_data_dir)
    warning(['Configured dir_formatting.default_raw_data_dir "%s" does not exist ' ...
        'on this machine. Falling back to: %s'], ...
        run_params.dir_formatting.default_raw_data_dir, repo_root);
    run_params.dir_formatting.default_raw_data_dir = repo_root;
end
